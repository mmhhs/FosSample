...
public class TxMainActivity extends AppCompatActivity {
    ...
    private static final Logger logger = LoggerFactory.getLogger(TxMainActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maintx);
        ...
        final AudioRecognizeStateListener audioRecognizeStateListener = new AudioRecognizeStateListener() {
            ...
            public void onVoiceVolume(AudioRecognizeRequest request, final int volume) {
                ...
                handler.post(new Runnable() {
                    @Override
                    public void run() {
                        TxMainActivity.this.volume.setText(getString(R.string.volume)+volume);
                    }
                });
            }
        ...
        start.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (aaiClient==null) {
                    try {
                        aaiClient = new AAIClient(TxMainActivity.this, appid, projectId, secretId, credentialProvider);
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(TxMainActivity.this);
