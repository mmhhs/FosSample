...
import com.little.picture.view.GlideCircleTransform;
...
public class GlideUtil {
    ...
    public void display(Context context,String url,ImageView mImageView){
        Glide.with(context)
                ...
                .placeholder(R.color.picture_light_grey)
                .error(R.color.picture_light_grey)
                .centerCrop()
//                .override(720, 360)
                .into(mImageView);
    }

    public void displayCenter(Context context,String url,ImageView mImageView){
        Glide.with(context)
                .load(url)
                .listener(mRequestListener)
                .priority(Priority.LOW)
